...
import partnerLogos from "figma:asset/00986a76ccf151cda0ea9ceb8177ada8a0ab0e1e.png";
import cashflowTable from "figma:asset/75e726933bbb3a51ca54d516753909622e3b2866.png";
        ...
        >
          ...
          <div className="flex justify-end gap-6 mb-8">
            <div className="flex items-center gap-2">
              ...
              <span className="text-white" style={{ fontSize: '15px' }}>투자자</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 bg-[#FF6A3D]" style={{ borderRadius: '4px' }}></div>
              <span className="text-white" style={{ fontSize: '15px' }}>건물주</span>
            </div>
          </div>
          ...
          {/* PC 버전 */}
          <div 
            className="bg-[#1B2E4A] mx-auto text-center mt-12 hidden md:block"
            style={{ 
              borderRadius: '24px', 
              padding: '40px 48px',
          ...
          >
            ...
            >
              <span>건물주에게 실질적 소유와</span>
              <span style={{ whiteSpace: 'nowrap' }}>
                극대화된 <span style={{ fontWeight: '700' }}>수익을 보장</span>하는 구조,
              </span>
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: '12px', whiteSpace: 'nowrap' }}>
                오직 <SolarOLogo size="medium" /> 와 함께!
              </span>
            </div>
          </div>
          ...
          {/* 모바일 버전 */}
          <div 
            className="bg-[#1B2E4A] mx-auto text-center mt-12 block md:hidden"
            style={{ 
              borderRadius: '16px', 
              padding: '24px 20px',
              border: '2px solid #FF6A3D',
        ...
        <div className="mt-20">
          ...
          >
            ...
            <div className="mb-8">
              ...
              >
                결과가 보여주는 현금흐름{' '}
                <span className="text-[#A8B4C8]" style={{ fontSize: 'clamp(20px, 4vw, 28px)' }}>(억원)</span>
              </h3>
            </div>

            {/* First Table: Years 1-15 */}
            <div className="mb-6 overflow-x-auto custom-scrollbar" style={{ width: '100%' }}>
              <table className="text-center border-collapse" style={{ fontSize: 'clamp(10px, 2vw, 13px)', minWidth: '800px', width: '100%' }}>
                <thead>
            ...
            <div className="mb-8 overflow-x-auto custom-scrollbar" style={{ width: '100%' }}>
              <table className="text-center border-collapse" style={{ fontSize: 'clamp(10px, 2vw, 12px)', minWidth: '800px', width: '100%' }}>
                <thead>
                  <tr className="bg-[#1B2E4A]">
            ...
            <div 
              ...
              style={{ 
                borderRadius: '24px', 
                padding: 'clamp(20px, 5vw, 28px) clamp(24px, 6vw, 40px)',
                border: '2px solid #FF6A3D'
              }}
            >
              <p 
              ...
              >
                1MW(약 2,000평)당{' '}
                <span className="text-[#FF6A3D]" style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }}>
                  15년간 11억, 35년간 61억
                </span>
                의 현금흐름 발생
              </p>
