...
{/* 그라운드 프로젝트 다이어그램 */}
export function ProjectDiagramGround_Investment() {
  return (
    <svg
      viewBox="0 0 800 600"
      className="w-full max-w-[800px] h-auto"
    ...
    >
      ...
      {/* 토지소유주 → 태양광발전 법인 대각선 1 (건물지붕 임대차 계약 체결) */}
      <line x1="230" y1="110" x2="560" y2="480" stroke="var(--gray-400)" strokeWidth="4" markerEnd="url(#arrowDown)" />
      <rect x="230" y="246" width="270" height="90" fill="var(--color-white-70)" />
      <text x="240" y="280" textAnchor="start" fill="var(--primary-dark-5)" fontSize="22" fontWeight="bold">
        ① 토지 임대차 계약 체결
...
export function ProjectDiagramGround_Cashflow() {
  return (
    <svg
      viewBox="0 0 800 600"
      className="w-full max-w-[800px] h-auto"
    ...
    >
      ...
      {/* 토지소유주 → 태양광발전 법인 대각선 1 (토지 임대차 계약 체결) */}
      <line x1="240" y1="120" x2="570" y2="490" stroke="var(--gray-400)" strokeWidth="4" markerStart="url(#arrowUp)" />
      <rect x="245" y="246" width="250" height="90" fill="var(--color-white-70)" />
      <text x="260" y="300" textAnchor="start" fill="var(--primary-dark-5)" fontSize="22" fontWeight="bold">
        ③ 잔여이익의 50% 배분
...
export function ProjectDiagramGround_AfterLoan() {
  return (
    <svg
      viewBox="0 0 800 600"
      className="w-full max-w-[800px] h-auto"
...
export function ProjectDiagramGround_AfterInvestment() {
  return (
    <svg
      viewBox="0 0 800 600"
      className="w-full max-w-[800px] h-auto"
...
{/* 주차장 프로젝트 다이어그램 */}
export function ProjectDiagramParking_Investment() {
  return (
    <svg
      viewBox="0 0 800 600"
      className="w-full max-w-[800px] h-auto"
...
export function ProjectDiagramParking_Cashflow() {
  return (
    <svg
      viewBox="0 0 800 600"
      className="w-full max-w-[800px] h-auto"
...
export function ProjectDiagramParking_AfterLoan() {
  return (
    <svg
      viewBox="0 0 800 600"
      className="w-full max-w-[800px] h-auto"
...
export function ProjectDiagramParking_AfterInvestment() {
  return (
    <svg
      viewBox="0 0 800 600"
      className="w-full max-w-[800px] h-auto"
