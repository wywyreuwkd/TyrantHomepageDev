    ...
    <div>
      ...
      {(activeTab === "all" || activeTab === "consulting") && (
        <section className="max-w mx-auto px-6 pt-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-5">
            ...
            <LogoItem src={uclickLogo.src} alt="UCLICK ASSET" delay={0.05} url="" height="80px"/>
          </div>
        </section>
      )} 
      ...
      {(activeTab === "all" || activeTab === "investment") && (
        <section className="max-w mx-auto px-6 pt-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-5">
            ...
            <LogoItem src={wandoLogo.src} alt="완도금일수협" delay={0.05} url="https://www.wando.suhyup.co.kr" height="80px" />
            <LogoItem src={gwangjuLogo.src} alt="광주은행" delay={0.10} url="https://www.kjbank.com" height="80px" />
            <LogoItem src={mgCapitalLogo.src} alt="MG캐피탈" delay={0.15} url="https://www.mgcapital.co.kr" height="80px" />
      ...
      {(activeTab === "all" || activeTab === "sales") && (
        <section className="max-w mx-auto px-6 pt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-5">
            <LogoItem src={sgGlobalLogo.src} alt="SG GLOBAL ENERGY KOREA" delay={0} url="https://sgenergy1.com" height="80px" />              
          </div>
        </section>
      )} 
      ...
      {(activeTab === "all" || activeTab === "equipment") && (
        <section className="max-w mx-auto px-6 pt-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-5">
            <LogoItem src={jbCorpLogo.src} alt="JB CORP" delay={0} url="https://www.jbcorp.co.kr" height="80px" />
            <LogoItem src={hanwhaLogo.src} alt="한화시스템" delay={0.05} url="https://www.hanwhasystems.com" height="80px" />
      ...
      {(activeTab === "all" || activeTab === "construction") && (
        <section className="max-w mx-auto px-6 pt-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-5">
            ...
            <LogoItem src={songJeonLogo.src} alt="송전" delay={0.40} url="http://www.songjeon.co.kr" height="80px" />
