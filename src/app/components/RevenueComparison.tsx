...
import partnerLogos from "../assets/00986a76ccf151cda0ea9ceb8177ada8a0ab0e1e.png";
import hanwhaLogo from "../assets/d2bd2442aa020550cbe75f6963070aa7f084923e.png";
import daeboLogo from "../assets/9277615fa3d362c1a6cea2a441685ccbd3036504.png";
import jbcorpLogo from "../assets/e9c6b069e143d1ad94dc4d9bbe90be0b28e047e4.png";
import cashflowTable from "../assets/75e726933bbb3a51ca54d516753909622e3b2866.png";
    ...
    <section className="bg-[#0E1C45] py-15 md:py-30">
      <div className="mx-auto px-6 md:px-10" style={{ maxWidth: '1280px' }}>
        ...
        <div className="text-left mb-12">
          <p className="text-[#FF6A3D] mb-2" style={{ fontSize: '20px', fontWeight: 'bold', lineHeight: '140%' }}>
            동일한 공간, 3배 이상의 수익 :
          </p>
          <h2 className="text-white" style={{ fontSize: '42px', fontWeight: 'bold', lineHeight: '140%' }}>
            구조의 차이가 만든 결과
          </h2>
        </div>
        ...
        <div className="mt-20">
          ...
          >
            {/* Title */}
            <div className="mb-8">
              <p className="text-[#FF6A3D] mb-1" style={{ fontSize: '18px', lineHeight: '140%' }}>
                건물주의 이익을 최우선 한
              </p>
              <h3 className="text-white" style={{ fontSize: '32px', fontWeight: 'bold', lineHeight: '140%' }}>
