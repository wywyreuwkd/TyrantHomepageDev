      ...
      content: (
        <div className="space-y-4 text-sm text-gray-700">
          <section>
            ...
            <p>본 약관은 조&김 렌터카(이하 "회사")가 제공하는 자동차 렌탈 및 리스 서비스의 이용과 관련하여 회사와 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.</p>
          </section>
          <section>
    ...
    <footer className="w-full bg-gray-50 border-t border-gray-200 mt-24">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-xs text-gray-500 space-y-2 mb-8">
          <p>
            법인명 : 조&김 / 대표이사 : 조원식&김산하 / 사업자 : 신용보 / 주소 : 경기도 / 전화 : 031-xxx-xxxx / 팩스 : 
          </p>
          <p>
            1인당대출한도액 : 2억원 그리고 산업 전체 한도 1조 4천억 / 등록번호제대주업자 : 서울-대출-0000-0
          </p>
          <p>
            전화번호(대표번호) : 031-xxxx / 2002-전주대여-007-xxx / 물품가지급기관업체 / 등록번호 : 2021-광진번-xxx2 / 시설대부번호 : 1600-770
          </p>
        </div>

        <div className="text-center text-xs text-gray-500 pt-8 border-t border-gray-200">
          © All rights reserved. 조&김
        </div>
      </div>
