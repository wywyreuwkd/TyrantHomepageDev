...
const generateMockApplicants = (): Applicant[] => {
  ...
  for (let i = 1; i <= 75; i++) {
    const date = new Date(2026, 0, 8 - Math.floor((i - 1) / 10));
    const hour = 23 - (i % 24);
    ...
    applicants.push({
      ...
      dateTime: `${date.getFullYear()}-${String(date.getMonth() + 1).padStart(2, '0')}-${String(date.getDate()).padStart(2, '0')} ${String(hour).padStart(2, '0')}:${String(minute).padStart(2, '0')}`,
  ...
  const users: User[] = [
    {
      ...
      userId: 'admin001',
      name: '조원식',
      lastAccess: '2026-01-08 14:23:45'
    },
    {
      id: 2,
      userId: 'admin002',
      name: '김산하',
      lastAccess: '2026-01-08 12:15:30'
    },
    {
      id: 3,
      userId: 'user003',
      name: '강준호',
      lastAccess: '2026-01-07 18:42:12'
    }
  ];
  ...
  const devices: Device[] = [
    {
      ...
      deviceType: 'Desktop',
      registeredDate: '2026-01-08 14:23:45',
      status: 'active'
    },
    {
      id: 2,
      ...
      deviceType: 'Mobile',
      registeredDate: '2026-01-08 12:15:30',
      status: 'active'
    },
    {
      id: 3,
      ...
      deviceType: 'Tablet',
      registeredDate: '2026-01-07 18:42:12',
      status: 'inactive'
    }
  ];
                          ...
                          <DialogContent className="p-0 overflow-hidden">
                            ...
                            <div className="px-4 py-3 bg-gray-50 flex justify-end">
                              <Button
                                onClick={() => {
                                  if (selectedDate) {
                                    setTempSearchDate(selectedDate.toISOString().split('T')[0]);
                                  }
