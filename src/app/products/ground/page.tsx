...
import { RevenueTable, revenueData_bareLand, revenueData_forestLand } from "@components/sections/RevenueTable";
import { CheckCircle2 } from "lucide-react";
import { 
  ProjectDiagramGround_Investment, ProjectDiagramGround_Cashflow, 
  ProjectDiagramGround_AfterLoan, ProjectDiagramGround_AfterInvestment,
} from "@components/sections/ProjectDiagram";

export const metadata: Metadata = {
  title: "솔라오 태양광 발전소 그라운드 태양광 상품 수익 안내",
  description: "솔라오 상품은 태양광 발전소를 나대지 또는 임야 등에 무상 설치해주는 상품으로 별도의 비용 없이 태양광 발전소를 설치하고, 수익을 얻을 수 있는 상품임."
};

export default function GroundProduct() {
  return (
    <div className="min-h-screen bg-primary pt-20">
      {/* Hero Section */}
      <HeroSection
        badge="GROUND PRODUCT OVERVIEW"
        title={<>솔라오(그라운드) 소개</>}
        description={
          <>
            <span>나대지 또는 삼림 등에 태양광 발전소를 설치하고, </span>
      ...
      <section className="bg-primary py-20 md:py-32">
        ...
        <div className="text-left mb-12">
            ...
            <div className="mt-4 text-left">
              <p className="text-xl color-gray-400 leading-[180%]">
                ...
                <br className="hidden md:block" />
                <span>차입금에 대한 상환의무는 타이런트가 부담하며, 토지 소유주의 신용에 영향을 미치지 않습니다. </span>
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="min-w-0 bg-gray-100 rounded-2xl p-6">
            ...
            <div className="overflow-x-auto">
              <div className="min-w-[500px]">
                <ProjectDiagramGround_Investment />
              </div>
            </div>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-[1280px] mx-auto px-6 md:px-10 pb-12">
          <div className="min-w-0 bg-gray-100 rounded-2xl p-6">
            ...
            <div className="overflow-x-auto">
              <div className="min-w-[500px]">
                <ProjectDiagramGround_AfterLoan />
              </div>
            </div>
          </div>
          ...
          <div className="min-w-0 bg-gray-100 rounded-2xl p-6">
            ...
            <div className="overflow-x-auto">
              <div className="min-w-[500px]">
                <ProjectDiagramGround_AfterInvestment />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gray-100 shadow-sm rounded-2xl py-8 px-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-start justify-center">
              <div className="bg-gray-200 border border-gray-300 rounded-xl leading-[140%] p-6">
                ...
                <p className="bullet-list-item color-primary-dark-5 text-md leading-[160%] mb-4">
                  특화된 사업 구조를 통해 토지 소유주의 신용에 대한 담보 설정 등의 영향 없이 자금을 조달합니다.
                </p>
                <p className="bullet-list-item color-primary-dark-5 text-md leading-[160%] mb-4">
                  사업 개시 후 발생되는 수익은 우선적으로 차입원리금 및 사업운영비 등 비용 지출 후 잔여이익을 토지주와 타이런트 간에 배분하는 방식으로 진행됩니다.
                </p>
              </div>
              ...
              <div className="bg-gray-200 border border-gray-300 rounded-xl leading-[140%] p-6">
                ...
                <p className="bullet-list-item color-primary-dark-5 text-md leading-[160%] mb-4">
                  2단계 차입원리금 상환 구간은 최초 1년차 ~ 16년차 동안 이뤄지고, 3단계 관리운영 구간은 17년차 ~ 20년차 동안 이뤄집니다.
                </p>
                <p className="bullet-list-item color-primary-dark-5 text-md leading-[160%] mb-4">
                  최종적으로 사업 개시 후 21년차 이후 태양광발전법인의 지분 및 태양광발전설비의 소유권은 최초 체결된 계약에 의해 무상으로 토지주에게 양도됩니다.
                </p>
                <p className="bullet-list-item color-primary-dark-5 text-md leading-[160%] mb-4">
                  설치되는 태양광 패널의 적정 수명은 35년 수준이며, 따라서 21년차 이후 발생되는 수익은 모두 토지주에게 귀속됩니다.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-100 shadow-sm rounded-2xl py-8 px-8">
            ...
            <div className="grid gap-8 items-start justify-center">
              <div className="bg-gray-200 border border-gray-300 rounded-xl leading-[140%] p-6">
                ...
                <p className="bullet-list-item color-primary-dark-5 text-md leading-[160%] mb-4">
                  부지 조건 및 개발행위허가 조건 등 제반 상황에 따라 상품의 구조가 변경될 수 있으며, 이때 계약의 실제 체결 내용은 상기 설명자료와 차이가 발생할 수 있습니다.
                </p>
                <p className="bullet-list-item color-primary-dark-5 text-md leading-[160%] mb-4">
      ...
      <section className="bg-white py-20 md:py-32">
          ...
          <div className="text-left mb-16">
            ...
            <div className="mt-4 text-left">
              <p className="text-xl color-gray-700 leading-[180%]">
                <span>일반적으로 약 2,000평 규모의 토지에 1,000kW 규모의 태양광 발전소 설치가 가능합니다. </span>
                <br className="hidden md:block" />
                <span>2,000평 규모 토지를 보유한 토지소유주가 1,000kW 규모의 태양광 모듈을 설치하면 그로 인한 수익은 어느 정도일까요? </span>
                <br />
                아래는 주요 가정(SMP 130원/kWh, REC 75원/kWh 등) 하에서 토지소유주에게 제공되는 수익을 표로 정리한 것입니다.
              </p>
            </div>
          </div>
        </div>
        <div className="grid lg:grid-cols-2 gap-12 max-w-[1280px] mx-auto px-6 md:px-10 pb-12">
          <div className="min-w-0 bg-primary rounded-2xl p-6">
            ...
            <div className="overflow-x-auto">
              <div className="min-w-[500px]">
                <RevenueTable data={revenueData_bareLand} />
              </div>
            </div>
            <p className="annotation-list-item color-gray-100 text-sm leading-[140%] mt-4">
              주요 가정: 설비용량 1,000kW, 일 평균 유효발전시간 3.5시간, SMP 130원/kWh, REC 75원/kWh, 차입금 상환기간 16년
            </p>
          </div>
          ...
          <div className="min-w-0 bg-primary rounded-2xl p-6">
            ...
            <div className="overflow-x-auto">
              <div className="min-w-[500px]">
                <RevenueTable data={revenueData_forestLand} />
              </div>
            </div>
            <p className="annotation-list-item color-gray-100 text-sm leading-[140%] mt-4">
              주요 가정: 설비용량 1,000kW, 일 평균 유효발전시간 3.5시간, SMP 130원/kWh, REC 75원/kWh, 차입금 상환기간 16년
          ...
          <div className="bg-primary-dark-4 shadow-sm rounded-2xl py-8 px-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-start justify-center">
              <div className="bg-white/5 border border-white-10 rounded-xl leading-[140%] p-6">
                ...
                <p className="bullet-list-item color-white-90 text-md leading-[160%] mb-4">
                  "[2단계] 차입원리금 상환 구간"은 표에서 "1년차" ~ "16년차"로 표시됩니다. 이 구간에서 나오는 수익금은 차입금 상환에 우선적으로 사용되고, 잔여 이익을 배분합니다.
                </p>
                <p className="bullet-list-item color-white-90 text-md leading-[160%] mb-4">
                  "[3단계]"는 "17년차" ~ "20년차"에 해당하는 구간으로 차입금 상환이 완료된 후 이어지는 구간입니다. 사업운영비를 지급한 후 잔여 이익을 배분합니다.
                </p>
                <p className="bullet-list-item color-white-90 text-md leading-[160%] mb-4">
                  "[4단계]"는 "21년차" 이후 부터 이어지는 구간으로 발생되는 수입의 전액이 토지주에게 배분됩니다.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white-10 rounded-xl leading-[140%] p-6">
                ...
                <p className="bullet-list-item color-white-90 text-md leading-[160%] mb-4">
                  <span className="font-semibold color-accent">인허가 절차:</span> 나대지는 상대적으로 간단한 개발행위허가가 필요하지만, 임야는 산지전용허가 등 추가적인 인허가 절차가 필요하여 사업 준비 기간이 더 소요될 수 있습니다.
                </p>
                <p className="bullet-list-item color-white-90 text-md leading-[160%] mb-4">
                  <span className="font-semibold color-accent">토목공사 비용:</span> 나대지는 기존 지형을 활용하여 설치가 가능하지만, 임야는 벌목, 정지작업, 배수로 설치 등 추가적인 토목공사가 필요하여 초기 사업비가 증가합니다.
                </p>
                <p className="bullet-list-item color-white-90 text-md leading-[160%] mb-4">
                  <span className="font-semibold color-accent">수익 배분 구조:</span> 임야는 추가 개발비용이 발생하므로 차입금 상환 구간의 수익 배분율이 나대지와 다르게 책정될 수 있으며, 이는 계약 시 상세하게 안내됩니다.
                </p>
              </div>
            </div>
          </div>
