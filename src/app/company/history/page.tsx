...
import { CheckCircle2, Award, TrendingUp, Users, Zap, Building2 } from "lucide-react";
        ...
        <div className="relative mx-auto px-6 md:px-10 py-20 md:py-32" style={{ maxWidth: '1280px' }}>
          <div className="max-w-3xl">
            ...
            <p style={{
              ...
              2021년 설립 이래, 혁신적인 수익공유 모델과 기술력으로<br className="hidden md:block" />
              대한민국 태양광 산업의 새로운 기준을 만들어가고 있습니다.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="mx-auto px-6 md:px-10" style={{ maxWidth: '1280px' }}>
          ...
          <div className="relative">
            {/* Timeline Line */}
            <div className="hidden lg:block absolute left-[100px] top-0 bottom-0 w-[2px] bg-gradient-to-b from-[#FF6B3D] via-[#00D9FF] to-[#0F214A]"></div>
