...
import { ProjectManagementSection } from "@/components/section/project-management/ProjectManagementSection";

export const metadata: Metadata = {
  title: "프로젝트 진행관리 | 타이런트 - 관리자",
  description: "타이런트 관리자 프로젝트 진행관리 페이지",
};
