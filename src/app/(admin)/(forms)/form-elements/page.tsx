...
import { FormElementsSection } from "@/components/section/forms/FormElementsSection";

export const metadata: Metadata = {
  title: "Form Elements | 타이런트 - 관리자",
  description: "타이런트 관리자 Form Elements 페이지",
};
      ...
      <div className="flex items-start justify-between gap-4 mb-12">
        <div>
          ...
          <p className="contents-sub-title mt-2 text-gray-600 dark:text-gray-400">
            프로젝트에서 사용되는 폼 엘리먼트 디자인 가이드 및 예제를 확인합니다
          </p>
        </div>
