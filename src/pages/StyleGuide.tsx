...
import tyrantLogo from "../assets/tyrant-logo-new.png";
import tyrantFullLogo from "figma:asset/a26d32a4cda9524da2386b79a668d32e665e1946.png";
import tyrantSymbol from "figma:asset/42084a9ed76544286cbbc6eee3e051e537b81c35.png";
import ceoMessageBadge from "figma:asset/0640f32130404845052111120f81221ab94b75c2.png";
import { SubNavigation } from "../components/SubNavigation";
import { ComponentSpecifications } from "../components/StyleGuideComponents";
...
export function StyleGuide({ onNavigate, currentPage = 'style-guide' }: StyleGuideProps) {
  // Ensure onNavigate is a function with fallback
  const handleNavigation = (page: any) => {
    if (onNavigate && typeof onNavigate === 'function') {
      onNavigate(page);
    } else {
      console.error('StyleGuide: onNavigate is not provided or not a function', { onNavigate, page });
      // Fallback: do nothing to prevent error
    }
  };

  return (
    <div className="min-h-screen bg-[#F7FAFD]" style={{ paddingTop: '80px' }}>
      {/* Sub Navigation */}
      <SubNavigation 
        category="company" 
      ...
      {/* Hero */}
      <div className="bg-gradient-to-br from-[#0F214A] to-[#273b82] py-24">
        <div className="mx-auto px-6" style={{ maxWidth: '1280px' }}>
          ...
          <p style={{
            ...
            타이런트 솔라오 웹사이트의 브랜드 아이덴티티, 디자인 원칙, UI 컴포넌트를 정의합니다.<br />
            모든 디자인 요소는 일관성과 전문성을 유지하기 위해 본 가이드를 준수해야 합니다.
          </p>
        </div>
      </div>

      <div className="mx-auto px-6 py-20 style-guide-content" style={{ maxWidth: '1280px' }}>
