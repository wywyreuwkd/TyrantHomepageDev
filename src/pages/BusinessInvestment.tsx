import { TrendingUp, BarChart3, Shield, DollarSign, Clock, CheckCircle2, Zap, FileText } from "lucide-react";
import { SubNavigation } from "../components/SubNavigation";

interface BusinessInvestmentProps {
  onNavigate: (page: string) => void;
  currentPage: string;
}

export function BusinessInvestment({ onNavigate, currentPage }: BusinessInvestmentProps) {
        ...
        <div className="mx-auto px-6 md:px-10" style={{ maxWidth: '1280px' }}>
          <div className="mb-16 text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 mb-6" style={{
              ...
              <BarChart3 size={16} style={{ color: '#FF6B3D' }} />
              <span style={{
                fontFamily: 'Pretendard, -apple-system, "Noto Sans KR", sans-serif',
                fontSize: '13px',
                fontWeight: '700',
